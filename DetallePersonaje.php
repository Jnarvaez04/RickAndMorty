...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://rickandmortyapi.com/api/character/2',
...
<ul class="nav" id= "inicio">
    ...
    <h2 class="title">Detalle Personaje</h2>
...
<form action="Detalle.php" method="POST">
  ...
  <div class="card-body">
    ...
    <a href="http://localhost:8080/Pelis/Detalle    .php"><button type="submit" class="btn btn-primary buton">Ver Personaje</button></a>
